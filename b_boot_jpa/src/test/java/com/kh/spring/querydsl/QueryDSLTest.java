...
public class QueryDSLTest {
	...
	@Test
	@DisplayName("대출건 제목이 '디디'로 시작하거나 대출자 ID가 jpa인 대출건을 모두 조회")
	public void whereOr() {
	...
	@Test
	@DisplayName("대출자 대출등록일자와 가입일자가 같은 회원이 존재하는지 확인")
	public void theataJoin() {
		queryDSLRepository.theataJoin().forEach(e -> log.info(e.toString()));
	}
	
	@Test
	@DisplayName("도서 재고 수량을 기준으로 내림차순으로 2권 까지 조회")
	public void orderBy() {
